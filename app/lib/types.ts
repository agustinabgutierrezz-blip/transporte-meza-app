...
export type Trip = { id: string; fecha: string | null; vehicle_id: string | null; driver_id: string | null; origen: string | null; destino: string | null; km: number | null; notas: string | null; costo_estimado: number | null };
...
export type Tarifa = { id: string; tipo_unidad: string; km_desde: number; km_hasta: number | null; precio: number };
